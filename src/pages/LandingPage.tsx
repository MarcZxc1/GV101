        ...
        <div className="grid gap-8 p-8 md:grid-cols-2 md:items-center">
          <div>
            ...
            <h1 className="mt-4 text-3xl font-semibold tracking-tight text-slate-900 md:text-4xl">
              Close the <span className="text-brand-700">Trust Gap</span> in
              home repairs.
            </h1>
            <p className="mt-3 text-slate-600">
              HandiLink matches homeowners with local tradespeople using
              reputation as currency: multi-dimensional ratings, deep reviews,
              and photo evidence that builds confidence.
            </p>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-3">
              <Feature
                ...
                desc="Search → pick → confirm in minutes."
              />
              <Feature
                title="No pricing anxiety"
                desc="Transparent breakdown before you commit."
              />
              <Feature
                title="Proof of work"
                desc="Before/after evidence on completed jobs."
              />
            </div>
          </div>

          <div className="rounded-3xl bg-linear-to-br from-brand-50 to-emerald-50 p-6 ring-1 ring-slate-200 shadow-sm">
            ...
            <ol className="mt-4 grid gap-3 text-sm text-slate-700">
              ...
              <li className="card p-4">
                ...
                <div className="mt-1 text-slate-600">
                  Auto badge for providers with &gt;4.7 overall and zero no-show
                  flags.
                </div>
              </li>
            </ol>
