...
export function BookingCheckoutPage() {
  ...
  const [issueSummary, setIssueSummary] = useState('Leaking faucet / minor repair')
      ...
      <section className="md:col-span-3">
        <div className="rounded-3xl border border-slate-200 bg-white p-7">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h2 className="text-2xl font-semibold text-slate-900">Booking / Checkout</h2>
          ...
          <div className="mt-6 grid gap-4">
            <div className="rounded-2xl bg-brand-50 p-4 ring-1 ring-brand-100">
              <div className="text-sm font-semibold text-brand-900">Three-click booking</div>
            ...
            <label className="grid gap-1">
              <span className="text-xs font-semibold text-slate-700">Issue summary</span>
              <input
                value={issueSummary}
              ...
              <div className="flex items-center justify-between text-xs">
                <span
                  className={
                    issueSummary.trim().length < 20 ? 'text-rose-600' : 'text-slate-500'
                  }
                >
                ...
                <span className="text-slate-500">{issueSummary.trim().length}/20</span>
              </div>
            </label>

            <div className="grid gap-3 md:grid-cols-2">
              <label className="grid gap-1">
                <span className="text-xs font-semibold text-slate-700">Schedule (QC time)</span>
                <input
                  type="datetime-local"
                  value={scheduledFor}
            ...
            <label className="grid gap-1">
              <span className="text-xs font-semibold text-slate-700">Payment method (simulated)</span>
