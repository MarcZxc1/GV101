...
export const mockProviders: Provider[] = [
  {
    ...
    hourlyRatePhp: 520,
    skills: ['Leak detection', 'Faucet replacement', 'Toilet repair', 'Pipe sealing'],
  ...
  },
  {
    ...
    hourlyRatePhp: 650,
    skills: ['Outlet diagnostics', 'Breaker checks', 'Lighting install', 'Wiring tidy-up'],
  ...
  },
  {
    ...
    location: { lat: 14.6760, lng: 121.0646 },
    serviceRadiusKm: 10,
  ...
  },
  {
    ...
    hourlyRatePhp: 560,
    skills: ['Drain clearing', 'Shower repair', 'Water pressure checks', 'Seal replacement'],
  ...
  },
  {
    ...
    hourlyRatePhp: 690,
    skills: ['Ceiling fan install', 'Switch replacement', 'Grounding checks', 'Lighting repair'],
...
function seedCompletedBookings(providerId: string, count: number): Booking[] {
  ...
  for (let i = 0; i < count; i++) {
    ...
    out.push({
      ...
      issueSummary: 'Seed completed booking to demonstrate verified badge logic.',
      createdAt: created.toISOString(),
      requestedAt: created.toISOString(),
      providerResponseDueAt: created.toISOString(),
      scheduledFor: scheduled.toISOString(),
      status: 'completed',
      priceQuotePhp: { calloutFee: 350, estimatedHours: 1, hourlyRate: 520, platformTrustFee: 49 },
      payment: { method: 'GCash', status: 'released', receiptId: `rcpt_${providerId}_${i}` },
      reviewId: undefined,
    })
  }
  return out
